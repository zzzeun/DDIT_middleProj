            ...
            <section class="search-area">
                <div class="inner">
                    <div class="search-box-wrap">
                    	<h1 class="tit tracking-in-expand">어떤 물품을 원하시나요?</h1>
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                	...
                                	<a id="href_pro1" data-path="${_ctx}/pro/proDetail.do?prod_id=<%=proVo.getProd_id()%>">
                               		  	
                               		  	<%  FileInfoVO file = (FileInfoVO) proVo.getFile_list().get(0); %>
                               		  	<% if(file != null) { %>
											<img src="${_ctx}/imageView?stored_nm=<%= file.getStored_nm() %>">
                                    	<% } else { %>
                                        	<img src="${_ctx}/imageView?stored_nm=x.png">
                                        <% } %>
                    ...
                    <div class="cont-area">
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                            	...
                            	%>
                                <div class="swiper-slide">
				                  	<a id="href_pro2" data-path="${_ctx}/pro/proDetail.do?prod_id=<%=proVo.getProd_id()%>">
                    ...
                    <div class="cont-area">
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                            	<!-- swiper-slide 시작 -->
                            	<%
                            		for(ProAndCateVO proVo : proNewList) {
                            	%>
                            	   <div class="swiper-slide">
                            	   		<a id="href_pro3" data-path="${_ctx}/pro/proDetail.do?prod_id=<%=proVo.getProd_id()%>">
                    ...
                    <div class="cont-area">
                        <div class="swiper noticeSwiper">
                            <div class="swiper-wrapper">
	                            ...
	                            %>
                              <div class="swiper-slide">
                              	<a id="href_comlist" data-path="${_ctx}/com/comDetail.do?com_id=<%=comVo.getCom_id()%>">
				                    <div class="txt-box">
	                    				<p class="dong"><%= comVo.getGu() %> <%= comVo.getDong() %></p>
	                    				<p class="tit"><%= comVo.getTit() %></p>
	                    				<div class="txt-wrap">
	                    					<p class="nickname"><%=comVo.getNick_nm()%></p>
	                    					<p class="insDt"><%=comVo.getIns_dt() %></p>
	                    				</div>
				                    </div>
                              	</a>
			              	  </div>
